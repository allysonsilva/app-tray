...
# @see https://github.com/laravel/framework/blob/12.x/src/Illuminate/Foundation/Console/OptimizeClearCommand.php
...
if [[ -d "vendor" && ${FORCE_OPTIMIZE:-true} == true ]]; then
    ...
    # @see https://github.com/laravel/framework/blob/12.x/src/Illuminate/Foundation/Console/OptimizeCommand.php
